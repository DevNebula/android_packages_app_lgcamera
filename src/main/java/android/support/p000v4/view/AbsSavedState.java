...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C16882());
    public static final AbsSavedState EMPTY_STATE = new C16871();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C16871 extends AbsSavedState {
        C16871() {
            super();
        }
    }
    ...
    static class C16882 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C16882() {
        }
