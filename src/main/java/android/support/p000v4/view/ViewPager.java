...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C16921();
    ...
    private static final Interpolator sInterpolator = new C16932();
    ...
    private final Runnable mEndScrollRunnable = new C16943();
    ...
    static class C16921 implements Comparator<ItemInfo> {
        C16921() {
        }
    ...
    static class C16932 implements Interpolator {
        C16932() {
        }
    ...
    class C16943 implements Runnable {
        C16943() {
        }
    ...
    class C16954 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C16961());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C16961 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C16961() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C16954());
    }
