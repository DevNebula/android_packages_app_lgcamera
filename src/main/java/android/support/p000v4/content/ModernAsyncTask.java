...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C16201();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C16212();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C16201 implements ThreadFactory {
    ...
    class C16212 extends WorkerRunnable<Params, Result> {
        C16212() {
        }
