...
import android.support.p000v4.p003os.IResultReceiver.Stub;

@RestrictTo({Scope.LIBRARY_GROUP})
/* renamed from: android.support.v4.os.ResultReceiver */
public class ResultReceiver implements Parcelable {
    public static final Creator<ResultReceiver> CREATOR = new C16271();
    final Handler mHandler;
    final boolean mLocal;
    IResultReceiver mReceiver;

    /* renamed from: android.support.v4.os.ResultReceiver$1 */
    static class C16271 implements Creator<ResultReceiver> {
        C16271() {
        }
