...
import android.support.p000v4.p003os.ResultReceiver;
...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C15481();
        ...
        static class C15481 implements Creator<MediaItem> {
            C15481() {
            }
