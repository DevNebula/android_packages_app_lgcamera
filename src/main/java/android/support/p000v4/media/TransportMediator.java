...
public class TransportMediator extends TransportController {
    ...
    class C15671 implements TransportMediatorCallback {
        C15671() {
        }
    ...
    class C15682 implements Callback {
        C15682() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C15671();
        this.mKeyEventCallback = new C15682();
