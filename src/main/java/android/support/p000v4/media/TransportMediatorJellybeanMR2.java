...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C15724();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C15735();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C15713();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C15746();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C15691();
    final OnWindowFocusChangeListener mWindowFocusListener = new C15702();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C15691 implements OnWindowAttachListener {
        C15691() {
        }
    ...
    class C15702 implements OnWindowFocusChangeListener {
        C15702() {
        }
    ...
    class C15713 extends BroadcastReceiver {
        C15713() {
        }
    ...
    class C15724 implements OnAudioFocusChangeListener {
        C15724() {
        }
    ...
    class C15735 implements OnGetPlaybackPositionListener {
        C15735() {
        }
    ...
    class C15746 implements OnPlaybackPositionUpdateListener {
        C15746() {
        }
