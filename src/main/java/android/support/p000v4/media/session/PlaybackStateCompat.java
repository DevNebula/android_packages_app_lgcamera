...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C15871();
    ...
    static class C15871 implements Creator<PlaybackStateCompat> {
        C15871() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C15881();
        ...
        static class C15881 implements Creator<CustomAction> {
            C15881() {
            }
