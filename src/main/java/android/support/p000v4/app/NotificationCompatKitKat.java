...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        /* renamed from: b */
        private android.app.Notification.Builder f67b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f67b, action));
        }
        ...
        public Notification build() {
            ...
            this.f67b.setExtras(this.mExtras);
            Notification notification = this.f67b.build();
