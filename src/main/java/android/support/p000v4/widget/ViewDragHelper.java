...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C17161();
    ...
    private final Runnable mSetIdleRunnable = new C17172();
    ...
    static class C17161 implements Interpolator {
        C17161() {
        }
    ...
    class C17172 implements Runnable {
        C17172() {
        }
