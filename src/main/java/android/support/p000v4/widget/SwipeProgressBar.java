...
final class SwipeProgressBar {
    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            long iterations = (now - this.mStartTime) / CameraConstants.TOAST_LENGTH_SHORT;
            float rawProgress = ((float) ((now - this.mStartTime) % CameraConstants.TOAST_LENGTH_SHORT)) / 20.0f;
            if (!this.mRunning) {
