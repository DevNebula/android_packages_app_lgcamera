...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C17081 implements AnimationListener {
        C17081() {
        }
    ...
    class C17092 extends Animation {
        C17092() {
        }
    ...
    class C17103 extends Animation {
        C17103() {
        }
    ...
    class C17125 implements AnimationListener {
        C17125() {
        }
    ...
    class C17136 extends Animation {
        C17136() {
        }
    ...
    class C17147 extends Animation {
        C17147() {
        }
    ...
    class C17158 extends Animation {
        C17158() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C17081();
        this.mAnimateToCorrectPosition = new C17136();
        this.mAnimateToStartPosition = new C17147();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C17092();
    ...
    void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C17103();
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C17158();
