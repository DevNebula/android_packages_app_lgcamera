...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C00661();
    ...
    public static class LayoutParams extends android.support.p001v7.widget.RecyclerView.LayoutParams {
        ...
        public LayoutParams(android.support.p001v7.widget.RecyclerView.LayoutParams source) {
            super(source);
        }
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C00671();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C00671 implements Creator<FullSpanItem> {
                C00671() {
                }
