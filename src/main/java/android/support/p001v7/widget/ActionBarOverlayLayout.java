...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0082R.attr.actionBarSize, 16842841};
    ...
    class C14991 extends ViewPropertyAnimatorListenerAdapter {
        C14991() {
        }
    ...
    class C15002 implements Runnable {
        C15002() {
        }
    ...
    class C15013 implements Runnable {
        C15013() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C14991();
        this.mRemoveActionBarHideOffset = new C15002();
        this.mAddActionBarHideOffset = new C15013();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0082R.C0081id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0082R.C0081id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0082R.C0081id.action_bar));
        }
    }
