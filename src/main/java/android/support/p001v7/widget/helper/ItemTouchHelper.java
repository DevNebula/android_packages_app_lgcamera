...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    /* renamed from: UP */
    public static final int f5UP = 1;
    int mActionState = 0;
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C00702();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C00691();
    ...
    class C00702 implements OnItemTouchListener {
        C00702() {
        }
            ...
            if (action == 0) {
                ...
                if (ItemTouchHelper.this.mSelected == null) {
                    ...
                    if (animation != null) {
                        ...
                        itemTouchHelper.mInitialTouchX -= animation.f3mX;
                        itemTouchHelper = ItemTouchHelper.this;
                        itemTouchHelper.mInitialTouchY -= animation.f4mY;
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        public void update() {
            if (this.mStartDx == this.mTargetX) {
                this.f3mX = ViewCompat.getTranslationX(this.mViewHolder.itemView);
            } else {
                this.f3mX = this.mStartDx + (this.mFraction * (this.mTargetX - this.mStartDx));
            }
            if (this.mStartDy == this.mTargetY) {
                this.f4mY = ViewCompat.getTranslationY(this.mViewHolder.itemView);
            } else {
                this.f4mY = this.mStartDy + (this.mFraction * (this.mTargetY - this.mStartDy));
            }
        }
    ...
    class C00745 implements ChildDrawingOrderCallback {
        C00745() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C00751();
        private static final Interpolator sDragViewScrollCapInterpolator = new C00762();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C00751 implements Interpolator {
            C00751() {
            }
        ...
        static class C00762 implements Interpolator {
            C00762() {
            }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0084R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        void onDraw(Canvas c, RecyclerView parent, ViewHolder selected, List<RecoverAnimation> recoverAnimationList, int actionState, float dX, float dY) {
            ...
            for (int i = 0; i < recoverAnimSize; i++) {
                ...
                anim.update();
                count = c.save();
                onChildDraw(c, parent, anim.mViewHolder, anim.f3mX, anim.f4mY, anim.mActionState, false);
        ...
        void onDrawOver(Canvas c, RecyclerView parent, ViewHolder selected, List<RecoverAnimation> recoverAnimationList, int actionState, float dX, float dY) {
            ...
            for (i = 0; i < recoverAnimSize; i++) {
                ...
                count = c.save();
                onChildDrawOver(c, parent, anim.mViewHolder, anim.f3mX, anim.f4mY, anim.mActionState, false);
                c.restoreToCount(count);
            }
            if (selected != null) {
                count = c.save();
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0084R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0084R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    View findChildView(MotionEvent event) {
        ...
        for (int i = this.mRecoverAnimations.size() - 1; i >= 0; i--) {
            ...
            if (ItemTouchHelper.hitTest(view, x, y, anim.f3mX, anim.f4mY)) {
                return view;
            }
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C00745();
            }
