...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C14891 implements OnAttachStateChangeListener {
        C14891() {
        }
    ...
    class C14902 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C14891());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C14902());
    }
