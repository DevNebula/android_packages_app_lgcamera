...
import android.support.p000v4.p003os.TraceCompat;
...
import android.support.p001v7.recyclerview.C0084R;
import android.support.p001v7.widget.AdapterHelper.UpdateOp;
import android.support.p001v7.widget.ChildHelper.Callback;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C00603();
    ...
    public static abstract class LayoutManager {
        ...
        public void measureChild(View child, int widthUsed, int heightUsed) {
            ...
            int widthSpec = LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), (getPaddingLeft() + getPaddingRight()) + (widthUsed + (insets.left + insets.right)), lp.width, canScrollHorizontally());
            int heightSpec = LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), (getPaddingTop() + getPaddingBottom()) + heightUsed, lp.height, canScrollVertically());
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0084R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0084R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0084R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0084R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0084R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C00603 implements Interpolator {
        C00603() {
        }
    ...
    class C00614 implements ProcessCallback {
        C00614() {
        }
    ...
    class C00625 implements Callback {
        C00625() {
        }
    ...
    class C00636 implements AdapterHelper.Callback {
        C00636() {
        }
    ...
    public final class Recycler {
        ...
        android.support.p001v7.widget.RecyclerView.ViewHolder getScrapViewForPosition(int r12, int r13, boolean r14) {
            /*
            r11 = this;
            r10 = -1;
        ...
        L_0x000a:
            r7 = r11.mAttachedScrap;
            r1 = r7.get(r2);
            r1 = (android.support.p001v7.widget.RecyclerView.ViewHolder) r1;
        ...
        L_0x001e:
            ...
            if (r7 != 0) goto L_0x00b6;
        L_0x0024:
            r7 = android.support.p001v7.widget.RecyclerView.this;
            r7 = r7.mState;
            r7 = r7.mInPreLayout;
        ...
        L_0x0082:
            r5 = android.support.p001v7.widget.RecyclerView.getChildViewHolderInt(r6);
            r7 = android.support.p001v7.widget.RecyclerView.this;
            r7 = r7.mChildHelper;
            r7.unhide(r6);
            r7 = android.support.p001v7.widget.RecyclerView.this;
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00641());
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C00641 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00641() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C00581();
        ...
        this.mItemAnimatorRunner = new C00592();
        this.mViewInfoProcessCallback = new C00614();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0084R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0084R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0084R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C00625());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C00636());
    }
    ...
    public void requestChildFocus(View child, View focused) {
        ...
        if (!(this.mLayout.onRequestChildFocus(this, this.mState, child, focused) || focused == null)) {
            Rect rect;
            this.mTempRect.set(0, 0, focused.getWidth(), focused.getHeight());
            LayoutParams focusedLayoutParams = focused.getLayoutParams();
    ...
    /* JADX WARNING: Missing block: B:80:0x036f, code:
    ...
    L_0x02d2:
        r18 = ALLOW_PREFETCHING;
        if (r18 == 0) goto L_0x009d;
    L_0x02d6:
        r0 = r23;
        r0 = r0.mViewPrefetcher;
        r18 = r0;
        r0 = r18;
