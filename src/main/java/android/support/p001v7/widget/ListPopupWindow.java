...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C15153 implements OnItemSelectedListener {
        C15153() {
        }
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0082R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0082R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0082R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0082R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0082R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    public boolean onKeyDown(int keyCode, @NonNull KeyEvent event) {
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !ListPopupWindow.isConfirmKey(keyCode))) {
            boolean below;
    ...
    public boolean onKeyUp(int keyCode, @NonNull KeyEvent event) {
        ...
        if (!consumed || !ListPopupWindow.isConfirmKey(keyCode)) {
            return consumed;
        }
        dismiss();
        return consumed;
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C15142();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C15153());
