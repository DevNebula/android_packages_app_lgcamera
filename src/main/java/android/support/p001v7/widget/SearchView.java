...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C152010 implements OnItemClickListener {
        C152010() {
        }
    ...
    class C152111 implements OnItemSelectedListener {
        C152111() {
        }
    ...
    class C152212 implements TextWatcher {
        C152212() {
        }
    ...
    class C15242 implements Runnable {
        C15242() {
        }
    ...
    class C15264 implements OnFocusChangeListener {
        C15264() {
        }
    ...
    class C15275 implements OnLayoutChangeListener {
        C15275() {
        }
    ...
    class C15286 implements OnGlobalLayoutListener {
        C15286() {
        }
    ...
    class C15297 implements OnClickListener {
        C15297() {
        }
    ...
    class C15308 implements OnKeyListener {
        C15308() {
        }
    ...
    class C15319 implements OnEditorActionListener {
        C15319() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C15321());
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C15321 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C15321() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0082R.attr.autoCompleteTextViewStyle);
        }
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp >= CameraConstants.MENU_TYPE_FULL_SCREEN_GUIDE && heightDp >= CameraConstantsEx.HD_SCREEN_RESOLUTION && config.orientation == 2) {
                return 256;
            }
            if (widthDp >= 600 || (widthDp >= 640 && heightDp >= CameraConstants.SHUTTER_ZOOM_SUPPORTED_MIN_ZOOM_LEVEL)) {
                return 192;
            }
            return 160;
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0082R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C15231();
        this.mUpdateDrawableStateRunnable = new C15242();
        this.mReleaseCursorRunnable = new C15253();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C15297();
        this.mTextKeyListener = new C15308();
        this.mOnEditorActionListener = new C15319();
        this.mOnItemClickListener = new C152010();
        this.mOnItemSelectedListener = new C152111();
        this.mTextWatcher = new C152212();
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0082R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0082R.styleable.SearchView_layout, C0082R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0082R.C0081id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0082R.C0081id.search_edit_frame);
        this.mSearchPlate = findViewById(C0082R.C0081id.search_plate);
        this.mSubmitArea = findViewById(C0082R.C0081id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0082R.C0081id.search_button);
        this.mGoButton = (ImageView) findViewById(C0082R.C0081id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0082R.C0081id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0082R.C0081id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0082R.C0081id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0082R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0082R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0082R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0082R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0082R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0082R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0082R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0082R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0082R.styleable.SearchView_suggestionRowLayout, C0082R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0082R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C15264());
        setIconifiedByDefault(a.getBoolean(C0082R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0082R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0082R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0082R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0082R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0082R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0082R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C15275());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C15286());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0082R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0082R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0082R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0082R.dimen.abc_dropdownitem_text_padding_left) : 0;
