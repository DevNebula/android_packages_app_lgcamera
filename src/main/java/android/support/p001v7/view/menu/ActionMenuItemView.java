...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, OnLongClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0082R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0082R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return widthDp >= CameraConstants.SHUTTER_ZOOM_SUPPORTED_MIN_ZOOM_LEVEL || ((widthDp >= 640 && ConfigurationHelper.getScreenHeightDp(getResources()) >= CameraConstants.SHUTTER_ZOOM_SUPPORTED_MIN_ZOOM_LEVEL) || config.orientation == 2);
    }
