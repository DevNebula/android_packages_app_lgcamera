...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C14851();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C14862();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C14873();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$1 */
    class C14851 extends ViewPropertyAnimatorListenerAdapter {
        C14851() {
        }
    ...
    class C14862 extends ViewPropertyAnimatorListenerAdapter {
        C14862() {
        }
    ...
    class C14873 implements ViewPropertyAnimatorUpdateListener {
        C14873() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0082R.C0081id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0082R.C0081id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0082R.C0081id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0082R.C0081id.action_bar_container);
        ...
        if (a.getBoolean(C0082R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0082R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        throw new IllegalStateException(new StringBuilder().append("Can't make a decor toolbar out of ").append(view).toString() != null ? view.getClass().getSimpleName() : CameraConstants.NULL);
    }
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0082R.attr.actionBarWidgetTheme, outValue, true);
