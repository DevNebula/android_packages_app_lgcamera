...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C14842();
    private final Runnable mMenuInvalidator = new C14831();
    ...
    class C14842 implements OnMenuItemClickListener {
        C14842() {
        }
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0082R.layout.abc_list_menu_item_layout);
