...
public class StickerMessage {
    private static final int MSG_ACTION_BASE = 0;
    private static final int MSG_COMMON_SATUS_BASE = 0;
    public static final int MSG_EYE_BLINK_CHANGED = 2;
    public static final int MSG_EYE_BROW_RAISE_CHANGED = 3;
    private static final int MSG_FACE_BASE = 16;
    ...
    private static final int MSG_PRGRESS_BASE = 32;
    public static final int MSG_PROCESS_CHANGED = 33;
    private static final int MSG_RECORDER_BASE = 256;
    private static final int MSG_RECORDER_ERROR_BASE = 512;
    private static final int MSG_RECORDER_STATUS_BASE = 256;
    public static final int MSG_STICKER_RESOURCE_BROKEN = 769;
    private static final int MSG_STICKER_RESOURCE_ERROR_BASE = 768;
}
