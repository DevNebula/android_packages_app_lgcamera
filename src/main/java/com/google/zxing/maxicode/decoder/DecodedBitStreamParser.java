...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f80FS = '\u001c';
    /* renamed from: GS */
    private static final char f81GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';
    /* renamed from: NS */
    private static final char f82NS = '￻';
    private static final char PAD = '￼';
    /* renamed from: RS */
    private static final char f83RS = '\u001e';
        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (!result.toString().startsWith("[)>\u001e01\u001d")) {
                    result.insert(0, postcode + f81GS + country + f81GS + service + f81GS);
                    break;
                }
                result.insert(9, postcode + f81GS + country + f81GS + service + f81GS);
                break;
            case 4:
