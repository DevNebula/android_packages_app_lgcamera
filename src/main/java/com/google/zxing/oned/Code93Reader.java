...
public final class Code93Reader extends OneDReader {
    ...
    static {
        int[] iArr = new int[]{276, 328, 324, 322, 296, 292, 290, 336, 274, 266, 424, Panorama.STATUS_ERROR_TOO_FAR_UP, 418, 404, Panorama.STATUS_ERROR_ALIGNMENT_FAILURE, 394, 360, 356, 354, 308, 282, 344, 332, 326, 300, 278, 436, 434, 428, Panorama.STATUS_ERROR_TOO_FAR_LEFT, 406, Panorama.STATUS_ERROR_WRONG_DIRECTION_UP, 364, 358, 310, 314, 302, 468, 466, 458, 366, 374, Panorama.STATUS_ERROR_SAVING_FAILURE, 294, 474, 470, 306, 350};
