...
public enum ServiceEventId implements EnumLite {
    ...
    public static final int f58x3c849eb4 = 168;
    ...
    public static final int f59x92bfb063 = 149;
    ...
    /* renamed from: com.google.android.apps.gsa.search.shared.service.proto.ServiceEventId$1 */
    class C16031 implements EnumLiteMap<ServiceEventId> {
        C16031() {
        }
    ...
    private ServiceEventId(int value) {
        this.value = value;
    }
}
