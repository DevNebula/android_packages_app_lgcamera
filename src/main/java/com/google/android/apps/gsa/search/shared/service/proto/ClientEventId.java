...
public enum ClientEventId implements EnumLite {
    ...
    /* renamed from: com.google.android.apps.gsa.search.shared.service.proto.ClientEventId$1 */
    class C15991 implements EnumLiteMap<ClientEventId> {
        C15991() {
        }
    ...
    private ClientEventId(int value) {
        this.value = value;
    }
}
