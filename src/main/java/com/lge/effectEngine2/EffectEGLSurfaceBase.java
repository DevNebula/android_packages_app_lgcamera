...
public class EffectEGLSurfaceBase {
    ...
    public EffectEGLSurfaceBase(EGLContext sharedContext, Surface surface, int flag) {
        if (surface == null) {
    ...
    public EffectEGLSurfaceBase(EGLContext sharedContext, Surface surface, int flag, int w, int h) {
        if (surface == null) {
            throw new NullPointerException();
        }
        this.mSurface = surface;
    ...
    private EGLConfig getConfig(int flags, int version) {
        ...
        attribList[10] = 12326;
        attribList[12] = 12352;
        attribList[13] = renderableType;
        attribList[14] = EGL_RECORDABLE_ANDROID;
        attribList[15] = 1;
        attribList[16] = 12344;
        attribList[18] = 12344;
        if ((flags & 1) != 0) {
    ...
    public void releaseRecordingEGL() {
        if (this.mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
