...
public final class ImageSizeUtils {
    /* renamed from: $SWITCH_TABLE$com$nostra13$universalimageloader$core$assist$ViewScaleType */
    private static /* synthetic */ int[] f54x8c64a0f9 = null;
    private static final int DEFAULT_MAX_BITMAP_DIMENSION = 2048;
    private static ImageSize maxBitmapSize;

    /* renamed from: $SWITCH_TABLE$com$nostra13$universalimageloader$core$assist$ViewScaleType */
    static /* synthetic */ int[] m16x8c64a0f9() {
        int[] iArr = f54x8c64a0f9;
        if (iArr == null) {
    ...
    public static int computeImageSampleSize(ImageSize srcSize, ImageSize targetSize, ViewScaleType viewScaleType, boolean powerOf2Scale) {
        ...
        int halfWidth;
        int halfHeight;
        switch (m16x8c64a0f9()[viewScaleType.ordinal()]) {
            case 1:
                if (!powerOf2Scale) {
