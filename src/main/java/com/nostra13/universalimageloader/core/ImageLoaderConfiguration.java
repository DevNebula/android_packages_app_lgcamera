...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
        ...
        public Builder taskExecutor(Executor executor) {
            if (!(this.threadPoolSize == 3 && this.threadPriority == 3 && this.tasksProcessingType == DEFAULT_TASK_PROCESSING_TYPE)) {
                C1596L.m22w(WARNING_OVERLAP_EXECUTOR, new Object[0]);
            }
        ...
        public Builder memoryCacheSize(int memoryCacheSize) {
            ...
            if (this.memoryCache != null) {
                C1596L.m22w(WARNING_OVERLAP_MEMORY_CACHE, new Object[0]);
            }
        ...
        public Builder diskCacheSize(int maxCacheSize) {
            ...
            if (this.diskCache != null) {
                C1596L.m22w(WARNING_OVERLAP_DISK_CACHE_PARAMS, new Object[0]);
            }
        ...
        public Builder diskCacheFileNameGenerator(FileNameGenerator fileNameGenerator) {
            if (this.diskCache != null) {
                C1596L.m22w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR, new Object[0]);
            }
    ...
    private static class NetworkDeniedImageDownloader implements ImageDownloader {
        ...
        private static /* synthetic */ int[] f51xb5a8500;
        private final ImageDownloader wrappedDownloader;

        /* renamed from: $SWITCH_TABLE$com$nostra13$universalimageloader$core$download$ImageDownloader$Scheme */
        static /* synthetic */ int[] m13xb5a8500() {
            int[] iArr = f51xb5a8500;
            if (iArr == null) {
        ...
        public InputStream getStream(String imageUri, Object extra) throws IOException {
            switch (m13xb5a8500()[Scheme.ofUri(imageUri).ordinal()]) {
                case 1:
                case 2:
    ...
    private static class SlowNetworkImageDownloader implements ImageDownloader {
        /* renamed from: $SWITCH_TABLE$com$nostra13$universalimageloader$core$download$ImageDownloader$Scheme */
        private static /* synthetic */ int[] f52xb5a8500;
        private final ImageDownloader wrappedDownloader;

        /* renamed from: $SWITCH_TABLE$com$nostra13$universalimageloader$core$download$ImageDownloader$Scheme */
        static /* synthetic */ int[] m14xb5a8500() {
            int[] iArr = f52xb5a8500;
            if (iArr == null) {
                iArr = new int[Scheme.values().length];
                try {
                    iArr[Scheme.ASSETS.ordinal()] = 5;
        ...
        public InputStream getStream(String imageUri, Object extra) throws IOException {
            ...
            switch (m14xb5a8500()[Scheme.ofUri(imageUri).ordinal()]) {
                case 1:
                case 2:
    ...
    private ImageLoaderConfiguration(Builder builder) {
        ...
        C1596L.writeDebugLogs(builder.writeLogs);
    }
