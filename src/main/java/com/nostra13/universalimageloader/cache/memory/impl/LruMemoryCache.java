...
public class LruMemoryCache implements MemoryCache {
    ...
    /* JADX WARNING: Missing block: B:9:0x0031, code:
            throw new java.lang.IllegalStateException(new java.lang.StringBuilder(java.lang.String.valueOf(getClass().getName())).append(".sizeOf() is reporting inconsistent results!").toString());
     */
